...
export default function Home() {
  ...
  const [ltAddress, setLtAddress] = useState(
    "FPtmoHC8vs7XuS67PqtxYBFnnERaEjQwv4H4UgBCsYRn"
  );
          ...
          <div className="gap-6 grid grid-cols-12 pt-5 w-full">
            ...
            <div className="gap-5 grid grid-cols-12 col-span-12">
              <div className="flex justify-center items-center gap-7 col-span-6 bg-[#eee] rounded-xl h-[150px]">
                {/* <CiSquarePlus className="text-[40px] hover:text-[#5680ce] cursor-pointer" onClick={() => { changeAmount(0, 0); }} /> */}
                ...
                {/* <CiSquareMinus className="text-[40px] hover:text-[#5680ce] cursor-pointer" onClick={() => { changeAmount(0, 1); }} /> */}
              </div>

              <div className="flex justify-center items-center gap-7 col-span-6 bg-[#eee] rounded-xl h-[150px]">
                {/* <CiSquarePlus className="text-[40px] hover:text-[#5680ce] cursor-pointer" onClick={() => { changeAmount(1, 0); }} /> */}
                <div className="flex justify-center items-center gap-4 leading-none">
                ...
                {/* <CiSquareMinus className="text-[40px] hover:text-[#5680ce] cursor-pointer" onClick={() => { changeAmount(1, 1); }} /> */}
              </div>
            </div>
