...
export default function ProSidebar() {
  ...
  return (
    <Sidebar backgroundColor="#fff">
      <div className="flex justify-start items-center px-8 w-full h-[50px] text-[20px]">
        Tokens
      </div>
      <Menu
        rootStyles={{
